...
.EXAMPLE
$VariableName = Get-PCF-Space-Eng -RITM RITM123456
...
[void] $listBox2.Items.Add('rnd')
[void] $listBox2.Items.Add('poc')
...
if ($result -eq [System.Windows.Forms.DialogResult]::OK)
	{
		$PCFSpaceEng = $listBox2.SelectedItem
    }
 return $PCFSpaceEng
}