function Get-Server-Identifier {
<#
...
.EXAMPLE
$VariableName = Get-Server-Identifier
...
#>
 Param(
 [Parameter(Mandatory = $true, HelpMessage="The servername WITHOUT dsglobal.org or other domain")]
