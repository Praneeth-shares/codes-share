...
.EXAMPLE
$VariableName = Get-PCF-Space-PP -RITM RITM123456
...
[void] $listBox2.Items.Add('intg')
[void] $listBox2.Items.Add('unit')
...
if ($result -eq [System.Windows.Forms.DialogResult]::OK)
	{
		$PCFSpacePP = $listBox2.SelectedItem
    }
 return $PCFSpacePP
}